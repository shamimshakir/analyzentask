            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="font-bold text-xl text-gray-600 pb-2">{{ __('Update User') }}</h3>
                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}" class="mt-4 space-y-4" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
